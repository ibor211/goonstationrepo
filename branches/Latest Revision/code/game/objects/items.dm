			...
			if (M.client)
				...
				if (!( safety ) && status == 1)
					...
					if (user.is_rev == 2 && M.is_rev == 0)
						M.is_rev = 1
						M << "\blue You are now a revolutionary. Help your cause. Do not harm your fellow freedom fighters. You can identify your comrades by the red \"R\" icons (or use the \"memory\" command)."
